...
import useOpenAuth from '@/hooks/useAuth';

const Detail = () => {
   const params = useParams();
   const [num, setNum] = useState<number>(0);
   const { open, setOpen } = useOpenAuth();
   ...
   const { data: detail, isLoading: loading1 } = useQuery({
   ...
   const { data: similarProduct, isLoading: loading2 } = useQuery({
      ...
      <div className='container space-y-20'>
               ...
               <Col span={8}>
                  ...
                  {detail && (
                     <div className='px-5 flex-column'>
                        <h1 className='text-4xl capitalize'>{detail.name}</h1>
                        ...
                        <div className='flex items-center py-2 mt-2 border-y'>
                           <span className='bg-[#EDEDED] text-red-500 px-3 py-1 rounded text-xs'>
                              -{detail.discount}%
                           </span>
                           <div className='flex items-center ml-auto space-x-1 justify-self-end'>
                              {`${detail.sold} ${t('sold')}`}
                           </div>
                        </div>
                        <div className='flex items-center mt-2 space-x-2'>
                           <span className='text-xl text-red-500 '>
                              {priceFormat(detail.prices.price, isVn)}
                           </span>
                           {detail.discount !== 0 && (
         ...
         {loading2 ? (
            ...
            <div className='space-y-3'>
               <h2 className='text-2xl'>{t('home.uLike')}</h2>
               <Swiper spaceBetween={8} slidesPerView={5} modules={[Scrollbar]}>
