...
const ProductForm: FC<ProductFormProps> = ({ product, value }) => {
                              ...
                              children={
                                 <div className='relative w-full'>
                                    <Input
                                       ...
                                       className='w-full !pl-8 capitalize appearance placeholder:normal-case focus:cursor-pointer'
                                       {...register('color')}
                                       isError={!!errors.color}
                                       readOnly
                                    />
                                    <div
                                       className='absolute w-4 -translate-y-1/2 bg-red-400 rounded-full top-1/2 left-2 aspect-square'
                                       style={{
                                          backgroundColor:
